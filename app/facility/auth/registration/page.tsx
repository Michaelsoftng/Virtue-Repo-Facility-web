...
const Registration: React.FC = () => {
    ...
    const [register] = useMutation(CreateUser, {
        variables: {
            ...
            user_type: UserType.FacilityAdmin
        },
        client,
    });
            ...
            <div className="w-full md:w-[350px] lg:w-[400px] mx-auto md:mt-3 lg:mt-0">
                <div className="">
                    <Form.Root className="w-full mx-auto" method='post' onSubmit={handleFormSubmit}>
                        <h3 className="text-black font-bold text-[20px] lg:text-[24px]">Facility Registration</h3>
                        ...
                        <Form.Field name="facility_name" className="block mb-4 mt-2">
                        ...
                        <Form.Field name="facility_type">
                          
                            <Form.Label htmlFor="facility_type" className="block font-semibold text-[14px]">
                                Facility type
                            </Form.Label>
                            ...
                            <select
                                ...
                                id="facility_type"
                                required
                                className="bg-white focus:outline-none focus:ring-2 focus:ring-[#09CFA0] px-[15px] py-[10px] text-[14px] font-medium text-black border border-gray-300 rounded-sm w-full"
                            >
                                <option defaultValue="facility">Select Facility Type</option>
                        ...
                        <Form.Field name="role" className="block mb-4 mt-2">
                            <Form.Label className="block font-semibold text-[14px]">Role</Form.Label>
                            <Form.Control onChange={handleFormChange}
                                type="text"
                                required
                                placeholder='Admin or Manager or Hr or PR'
                                className="focus:outline focus:outline-offset-0 focus:outline-[#09CFA0] px-[15px] py-[10px] text-[14px] font-medium text-black border-solid block border-[1.5px] rounded-sm border-gray-300 w-[100%] mx-auto"
                            />
                            <Form.Message className="text-sm text-red-500 grid grid-cols-[25px_calc(100%-25px)] mt-1 font-semibold" match="valueMissing">
